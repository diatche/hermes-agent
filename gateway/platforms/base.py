...
class BasePlatformAdapter(ABC):
    ...
    # "report the restore, then continue clear safe work"; non-interactive
    # event platforms (webhook) continue without an acknowledgement because
    # nobody is there to receive one (#57056). Read generically via ``getattr(adapter,
