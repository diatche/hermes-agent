...
class TestRegistration:
    def test_schema_allows_only_explicitly_approved_secret_entry(self):
        from tools.computer_use.schema import get_computer_use_schema

        description = get_computer_use_schema()["description"]
        assert "unless the user explicitly approved that specific use case" in description
        assert "stop and ask before acting on any unexpected credential or payment prompt" in description
