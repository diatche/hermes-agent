...
class TestAllowlist:
    def test_trace_upload_huggingface_requirement_preserves_local_embeddings(self):
        ...
        # Upstream deliberately converges the shared environment on the exact
        # lockfile version. Preserve the local safety boundary: the selected
        # pin must be in the Hindsight-compatible >=1.5,<2 window.
